...
public class Bird extends BaseObjects {
    private ArrayList<Bitmap> arrBms = new ArrayList<>();//Array pour animer l'oiseau
    ...
    public Bitmap getBm() {
        ...
        if (this.count == this.vFlap){
            ...
            count = 0; //count = 0 pour créer la boucle
        }
        /////// boucle pour rotate le piaf quand on arrete de cliquer
        ...
        //////// Fin de la boucle qui fait rotate le piaf quand on arrete de cliquer
